...
class cfgWeapons
{
	...
	{
		scope = 0;
		handAnim[] = {"OFP2_ManSkeleton","\DZ\anims\data\anim\sdr\ik\weapons\b95.rtm"};
		...
		chamberSize = 2;
		chamberedRound = "";
		camberableFrom[] = {"Ammo_308Win","CLIP_308Win_Snaploader"};
		magazines[] = {};
		barrelArmor = 550;
		ejectType = 3;
		...
		class Single: Mode_SemiAuto
		{
			...
			soundSetShot[] = {"B95_Shot_SoundSet","B95_Tail_SoundSet"};
			reloadTime = 0.1;
			recoil = "recoil_b95";
	...
	{
		scope = 2;
		descriptionShort = "Black coloured double barrelled hunting rifle. It is equipped with a single lock action. The rifle is uncocked after every shot. The notches that hold the mounting base are positioned directly above the chambers. The barrels float freely while the point of impact remains constant.";
		color = "Black";
	...
	{
		scope = 2;
		descriptionShort = "Green coloured double barrelled hunting rifle. It is equipped with a single lock action. The rifle is uncocked after every shot. The notches that hold the mounting base are positioned directly above the chambers. The barrels float freely while the point of impact remains constant.";
		color = "Green";
		lootCategory = "Crafted";
