...
//'now' is Sun Jul 28 07:39:32 2019 : 'file' last modified on Mon Dec 12 08:48:30 2016
////////////////////////////////////////////////////////////////////
...
class CfgWeapons
{
	...
	{
		scope = 0;
		handAnim[] = {"OFP2_ManSkeleton","\DZ\anims\data\anim\sdr\ik\weapons\pm63rak.rtm"};
		...
		magazines[] = {"M_PM73_25Rnd","M_PM73_15Rnd"};
		...
		class FullAuto: Mode_FullAuto
		{
			...
			soundSetShot[] = {"PM73_Shot_SoundSet","PM73_Tail_SoundSet"};
			reloadTime = 0.092;
			recoil = "recoil_rak";
	...
	class PM73Rak: PM73Rak_Base
	{
		...
		descriptionShort = "The Rak is a Polish submachine select-fire weapon that fires from an open bolt. Unlike Most SMGs firing from an open bolt position, the RAK features a reciprocating external breech bolt.";
		model = "\dz\weapons\firearms\pm73rak\pm73rak.p3d";
		attachments[] = {};
		baseAttachments[] = {};
		randomAttachments[] = {{"M_PM73_25Rnd","M_PM73_15Rnd","","","","","","","","","","","","","","","","","",""}};
		itemSize[] = {4,2};
		dexterity = 3.3;
