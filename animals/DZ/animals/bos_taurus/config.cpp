...
class CfgVehicles
{
	...
	class Animal_BosTaurus: AnimalBase
	{
		...
		class TrackingAgentTemplate
		{
			...
			class VisualTypes
			{
				class Steps_walk
				{
					textures[] = {"\DZ\animals\bos_taurus\step.jpg"};
					breadth = 1.0;
					stride = 2.0;
					offset = 1.0;
				};
				class Blood
				{
					textures[] = {"\DZ\animals\bos_taurus\blood.jpg"};
					breadth = 3.0;
					stride = 5.0;
					offset = 2.0;
				};
	...
	{
		scope = 2;
		displayName = "Bos Taurus Spotted";
